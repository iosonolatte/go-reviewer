      ...
      <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setKatagoForm({ ...katagoForm, path: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setKatagoForm({ ...katagoForm, configPath: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setKatagoForm({ ...katagoForm, modelPath: e.target.value })
                }
            ...
            <div>
              ...
              <div className="grid grid-cols-5 gap-2 mb-2">
                {[
                  { label: "⚡极速", value: 1, visits: 250, desc: "~2秒/手" },
                  { label: "🏃快速", value: 3, visits: 750, desc: "~5秒/手" },
                  { label: "⚖️均衡", value: 5, visits: 1250, desc: "~8秒/手" },
                  {
                    label: "🎯精确",
                    value: 10,
                    visits: 2500,
              ...
              <p className="text-xs text-go-woodLight">
                当前档位 {katagoForm.analyzeTime} → 每手约{" "}
                {katagoForm.analyzeTime * 250} 次 visits。
                值越大越准但越慢。实时落子推荐 <b>快速</b> 或 <b>均衡</b>
                ，复盘推荐 <b>精确</b>。
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setLLMForm({ ...llmForm, baseUrl: e.target.value })
                }
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          ...
          <div className="space-y-3 text-go-woodLight text-sm">
            ...
            <p>
              <strong>2. 配置引擎：</strong> 填写 KataGo
              可执行文件、配置文件（gtp_example.cfg）和权重文件（如
              kata1-b18c384nbt.bin.gz）的路径。
            </p>
            <p>
              <strong>3. 配置大语言模型：</strong> 填写 OpenAI API Key
              或其他兼容 OpenAI 协议的服务配置。
            </p>
            <p>
              <strong>4. 启动后端：</strong> 进入 backend 目录，运行{" "}
              <code className="bg-go-board px-2 py-0.5 rounded">
